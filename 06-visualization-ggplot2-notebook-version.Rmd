...
We start by loading our packages. **`ggplot2`** is included in the **`tidyverse`** package.
...
plot can also be generated with code like this by assigning a `ggplot` function to an object:
